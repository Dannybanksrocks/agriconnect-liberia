      ...
      <div className="container relative z-10 flex-1 flex flex-col justify-center pt-24 pb-16 md:pt-32 md:pb-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            a platform built to put knowledge and economic power in the hands of farmers across Liberia.
          </motion.p>
        ...
        >
          <FloatStatCard icon={Users}       label="Farmers"           value="2,400+"  trend="+18%"   delay={0.7}  />
