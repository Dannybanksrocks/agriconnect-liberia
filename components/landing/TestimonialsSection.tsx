...
const testimonials = [
  {
    quote:
      'AgriConnect showed me that rice prices in Gbarnga market were L$40 higher than my village buyer. I transported my harvest and earned an extra L$8,000 that season.',
    name: 'Fatu Kamara',
    role: 'Rice Farmer',
    county: 'Bong County',
    initials: 'FK',
        ...
        <div className="container">
          <div className="text-center mb-14">
            ...
            <p className="mt-3 text-lg text-stone-500">
              Real results from Liberian farmers using AgriConnect
            </p>
          </div>
      ...
      <section className="relative w-full py-16 md:py-20 bg-[#1B4332] overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
            Access AgriConnect from any mobile phone
          </h2>
