        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white">AgriHub Shop</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {['Rice & Grains', 'Vegetables', 'Root Crops', 'Fruits', 'Cash Crops', 'All Products'].map((c) => (
                <li key={c}><Link href="/shop/products" className="hover:text-green-400 transition">{c}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              {[
                ...
                <li key={item.href}><Link href={item.href} className="hover:text-green-400 transition">{item.label}</Link></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <div className="mt-3 p-3 rounded-lg bg-gray-800 border border-gray-700">
                ...
                <p className="text-lg font-bold text-green-400 mt-0.5">*347#</p>
                <p className="text-xs text-gray-500 mt-0.5">Any Liberian phone · MTN or Orange</p>
              </div>
            </div>
          </div>
        </div>
